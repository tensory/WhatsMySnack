 ...
 */
class SnackListViewModel(snackDataProvider: SnackDataProvider, private val confirmItemsPresenter: ConfirmItemsPresenter) : BaseObservable(), ConfirmItemsPresenter.OnDismissDelegate {
